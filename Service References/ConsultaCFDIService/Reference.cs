...
namespace MonthlyUpdate.ConsultaCFDIService {
    ...
    public interface IConsultaCFDIService {
        ...
        MonthlyUpdate.ConsultaCFDIService.Acuse Consulta(string expresionImpresa);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IConsultaCFDIService/Consulta", ReplyAction="http://tempuri.org/IConsultaCFDIService/ConsultaResponse")]
        System.Threading.Tasks.Task<MonthlyUpdate.ConsultaCFDIService.Acuse> ConsultaAsync(string expresionImpresa);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IConsultaCFDIServiceChannel : MonthlyUpdate.ConsultaCFDIService.IConsultaCFDIService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ConsultaCFDIServiceClient : System.ServiceModel.ClientBase<MonthlyUpdate.ConsultaCFDIService.IConsultaCFDIService>, MonthlyUpdate.ConsultaCFDIService.IConsultaCFDIService {
        ...
        public MonthlyUpdate.ConsultaCFDIService.Acuse Consulta(string expresionImpresa) {
            return base.Channel.Consulta(expresionImpresa);
        }
        
        public System.Threading.Tasks.Task<MonthlyUpdate.ConsultaCFDIService.Acuse> ConsultaAsync(string expresionImpresa) {
